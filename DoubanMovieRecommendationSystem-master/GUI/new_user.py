...
class NewUser(QWidget):
    def __init__(self, user):
        ...
        #self.movies_df = pd.read_csv('../Data/douban_movies_old.csv', encoding='utf-8')
        self.movies_df = pd.read_csv('../Data/douban_movies.csv',encoding='utf-8').fillna('')
        ...
        self.new_user_label1 = QLabel("<h2>Due to new user</h2>")
        self.new_user_label2 = QLabel("<h2>What is your favorite movie?</h2>")
        self.new_user_label3 = QLabel("<h3>E.g., Action, Comedy, Drama</h3>")
        self.new_user_like = QTextEdit(self)
        self.new_user_button = QPushButton("Submit", self)
        try:
