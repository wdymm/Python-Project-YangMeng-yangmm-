...
class NewMainWindow(QWidget):
    def __init__(self, movies):
        ...
        self.movie_detailed_button = QPushButton("Movie detail pag", self)
    ...
    def rec_movies_table_init(self):
        ...
        self.recommend_table.setHorizontalHeaderLabels(['Name', 'Actor', 'Rating', 'Genre', 'Date', 'Link'])
    ...
    def hot_movies_table_init(self):
        ...
        self.hot_movies_table.setHorizontalHeaderLabels(['Name', 'Actor', 'Rating', 'Genre', 'Date', 'Link'])
